...
console.log(
  chalk.yellow("YOUR CURRENCY CURRENT EXCHANGE VALUE IS:", toAmount)
);
console.log(
  chalk.blue(
    "CURRENCY CURRENT VALUE WITH WHOM YOU WANT TO EXCHANGE IS:",
    fromAmount
  )
);
console.log(
  chalk.greenBright(
    "THIS IS YOUR FINAL AMOUNT AFTER EXCHANGE ",
    convertedAmount
  )
);
